                                ...
                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                    ...
                                    <tbody>
                                        ...
                                        <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Download link : </p>
                                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #ffff; border-radius: 5px; text-align: center;">
                                                ${download}
                                                </td>
                                                </tr>
                                            </tbody>
